<div class="row">
    <div class="span5">
        ...
        <br />
        <h3 style="color: #BFBFBF;">Web-based personnel paging made easy.</h3>
    	...
    	<div class="well" style="padding-bottom: 10px;">
    		<a href="/register" class="btn btn-large btn-success">Get Started Now</a><br />
            <br />
			<h4 style="font-weight: normal;">Try it today with a 2 week free trial!</h4>
		</div>
    </div>
