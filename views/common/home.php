<div class="row">
    <div class="span8">
    	...
    	<div class="well" style="padding-bottom: 10px;">
    		<a href="/register" class="btn large success">Get Started Now</a>
			<h5>Try it today with a 2 week free trial</h5>
		</div>
    </div>
    <div class="span6" style="text-align: right;">
    	<img src="http://i.istockimg.com/file_thumbview_approve/5550637/2/stock-photo-5550637-female-robot.jpg" />
    </div>
</div>