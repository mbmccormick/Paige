<?php
	...
	function inbound_voice()
	{
		...
		echo "<Response>\n";
		echo "<Gather timeout='20' action='https://paigeapp.com/inbound/" . $_SESSION['CurrentAccount_ID'] . "/voice/menu' method='POST' numDigits='4'>\n";
	...
	function inbound_voice_menu()
	{
		...
		if ($_POST[Digits] == $customer->active_card->last4)
		{
			echo "<?xml version='1.0' encoding='UTF-8' ?>\n";
			echo "<Response>\n";
			echo "<Gather timeout='20' action='https://paigeapp.com/inbound/" . $_SESSION['CurrentAccount_ID'] . "/voice/confirm' method='POST' numDigits='1'>\n";
	...
	function inbound_voice_confirm()
	{
		...
		if ($_POST[Digits] == "1")
		{
			...
			RequestUrl("https://paigeapp.com/page/" . $_SESSION['CurrentAccount_ID'] . "/step1");
		}
	...
	function inbound_sms()
	{
		...
		if (strtolower($_POST[Body]) == "confirm")
		{
