<?php
    ...
    function accounts_add_post()
    {
        ...
        $purchasedNumber->update(array('VoiceUrl' => 'https://' . $_SERVER['HTTP_HOST'] . '/inbound/' . mysql_insert_id() . '/voice', 'SmsUrl' => 'https://' . $_SERVER['HTTP_HOST'] . '/inbound/' . mysql_insert_id() . '/sms'));
